...
function ChooseCity(a){
    $(".body_top span").eq(0).html("").addClass("back").css("background", "url(../images/newnavi/back.png) no-repeat");
...
//    }, function(){
//        $(this).css({
//            background: "url(../images/newnavi/backgroundshop.png) no-repeat"
//        })
//    });
    $(".cities li").find("span").bind("click", function(){
        ...
        $(".back").hover(function(){
            if ($(this).html() == "") {
                $(this).css("background", "url(../images/newnavi/back-hover.png) no-repeat")
            }
        }, function(){
            if ($(this).html() == "") {
                $(this).css("background", "url(../images/newnavi/back.png) no-repeat")
            }
        })
    });
...
//            border: "0px",
//            "margin-left": "10px"
//        }).addClass("shopareali").find("a").css("background", "url(../images/newnavi/backgroundshop.png) no-repeat");
...
function FindPosition(){
    if ($("#findcity").val() != "") {
        ...
        e = "   <div class='Guess'></div><div class='Guess_detail'></div><div class='Guess_Info'><div id='Guess'><img src='images/newnavi/loc.png' /><span>我们猜您在</span>" + c + "<div class='Error'>没猜对&nbsp;?<a id='showall'>显示全部>></a></div></div></div>";
        $("body").append(e);
        $(".Guess").width(b);
        $(".Guess").height(g);
