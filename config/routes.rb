Fandian::Application.routes.draw do
  match '/user_contact/CheckContactInfo' => "user_contacts#CheckContactInfo"
  ...
  resources :primary_businesses
  resources :shop_hours
  resources :cities
  resources :shops
  resources :areas
